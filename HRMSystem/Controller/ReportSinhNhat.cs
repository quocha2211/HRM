...
{
    public class ReportSinhNhatController : IucControlController
    {
        private ucBaseMasterDetail View;
        public BaseController masterController;
        public ucReportTemp masterForm;
        ...
        private void InitialMasterPage()
        {
            try
            {
                ...
                masterForm = new ucReportTemp() { Dock = DockStyle.Fill };
                masterForm.Source = typeof(ReportSinhNhat);
